...
public class Main {
	...
	private void GestionTempsUtilisation() {
		...
		*/
		...
		/*
		lien pour gerer la classe sp�cifique � une date : 
		...
		*/
		...
		//date de naissance si dessous forme ann�e,mois,jours
		LocalDate date3 = LocalDate.of(2000, 2, 3);
		System.out.println("Nombre de mois s�parant ma naissance "+ChronoUnit.MONTHS.between(date3,dateCourante)+ System.lineSeparator());
		
		/* 
		lien pour la classe sp�cifique au format :
		...
		*/
		...
		System.out.println("Nous sommes le " +  dateCourante.format(DateTimeFormatter.ofPattern("EEEE dd MMMM yyyy",Locale.FRANCE)) + "." 
							...
							+ "Je suis n� le " + date3.format(DateTimeFormatter.ofPattern("EEEE dd MMMM yyyy",Locale.FRANCE)) + "." + 
							System.lineSeparator()
							+ "Je suis quasiment n� le " + date4.format(DateTimeFormatter.ofPattern("EEEE dd MMMM yyyy",Locale.FRANCE)) + "." 
		...
		/*
		lien pour gerer la classe sp�cifique � une heure : 
		...
		*/
		...
		System.out.println("L'heure actuel est "+time1 + System.lineSeparator()
							+"Il y a 19749 minutes l'heure �tait "+time2 
							+ System.lineSeparator()+ System.lineSeparator());
		...
		/*
		lien pour gerer la classe sp�cifique � date et heure : 
		...
		*/
		...
		System.out.println("la dur�e de ma vie en heures est de : "+ldt2.until(ldt1,ChronoUnit.HOURS)+" heures.");
